...
namespace Betfair.ESASwagger.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Receive Time (in millis since epoch) that chagnes were received by the client
        /// </summary>
        /// <value>Receive Time (in millis since epoch) that chagnes were received by the client</value>
